...
public final class ProjectErrorMessage {
    ...
    public static final String THUMBNAIL_URL_OVER_MAX_LENGTH =
    ...
    public static final String DESCRIPTION_OVER_MAX_LENGTH =
